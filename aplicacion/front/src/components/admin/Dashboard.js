  ...
  return (
    <Fragment>
            <div className="row">
                ...
                <div className="col-12 col-md-10"> {/* aqui va el contenido de la pagina 12 columnas*/}
                    <h1 className="my-4">Dashboard</h1>

                        <Fragment>
                            <MetaData title={'Administracion'} /> {/* titulo de la pagina */}

                            <div className="row pr-4"> {/* de las 12 que tengo uso row de 4 columnas */}
                                <div className="col-xl-12 col-sm-12 mb-3">
                                    <div className="card text-white bg-primary o-hidden h-100"> {/* card de bootstrap */}
                            ...
                            <div className="row pr-4">
                                ...
                                <div className="col-xl-3 col-sm-6 mb-3"> {/* card */}
